...
from setter_backend.src.setter_backend.model.models import Route, Wall
from setter_backend.src.setter_backend.schema.schema import RouteCreate, RouteResponse, RouteUpdate
